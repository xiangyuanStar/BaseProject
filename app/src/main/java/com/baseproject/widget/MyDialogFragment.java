...
public class MyDialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public void setupDialog(MyDialog dialog, int style) {
        switch (style) {
            case 3:
    ...
    @NonNull
    public MyDialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        return new MyDialog(this.getActivity(), this.getTheme());
    }
